...
(function () {
	...
	const guideNavItems = document.getElementById('js-nav-items');
...
(function () {
	...
	const menu = document.querySelector('.c-guide-nav__btn');
	const items = menu.parentElement.querySelector('.c-guide-nav__items');
